 ...
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'AdjustWare_Cartalert')){ eqIhMiaqhoeCeehj('a2c23a8cb79a88a449107e2ee8213041'); ?><?php
/**
...
class AdjustWare_Cartalert_Model_Mysql4_Cartalert extends Mage_Core_Model_Mysql4_Abstract
{
    ...
    private function _getAbandonedCartsIds($fromDate, $toDate){
        ...
        $sql = $db->select()
            ...
            ->where('q.customer_group_id NOT IN ('.$group_id_ignore.')')
            ->where('q.is_active=1');
