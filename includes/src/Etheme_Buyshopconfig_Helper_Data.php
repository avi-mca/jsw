...
class Etheme_Buyshopconfig_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function getProductHover($_product, $el, $widthBig, $heightBig, $widthSmall, $heightSmall, $type = '',$show_short_description=true,$show_short_attributes=true,$price, $colors='')
    {
        $output = '';
...
//                $output .= $colors;
    ...
    public function getProductHtml($_product, $el, $widthBig, $heightBig, $span = 2, $special = false, $list_mode = false, $disable_info = false, $grid = true,$price,$izotope=false,$category_id=0,$colors='')
    {
        $output = '';
        $description = '';
