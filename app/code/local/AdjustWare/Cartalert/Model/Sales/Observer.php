 ...
 * File path:   app/code/local/AdjustWare/Cartalert/Model/Sales/Observer.php
 * Copyright:   (c) 2013 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'AdjustWare_Cartalert')){ kqfRZigqhIkQkkhy('c5065c793b998b0d5bbfa6b1598649f3'); ?><?php
class AdjustWare_Cartalert_Model_Sales_Observer extends Mage_Core_Model_Abstract
{
