 ...
 * File path:   app/code/local/AdjustWare/Cartalert/Model/Sales/Quote/Observer.php
 * Copyright:   (c) 2013 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'AdjustWare_Cartalert')){ aoQUjhmopCaTaapr('d13665a10e2d5b970a169cc9d4ebb25b'); ?><?php
class AdjustWare_Cartalert_Model_Sales_Quote_Observer extends Mage_Core_Model_Abstract
{
