...
class FME_Fieldsmanager_Adminhtml_Fme_FieldsController extends Mage_Adminhtml_Controller_Action
{
	...
	public function saveAction() {
	    ...
	    if (!isset($data['is_configurable'])) {
            ...
            if($data['frontend_input']=='message'){
                ...
                $defaultValueField = 'default_value_yesno';
            }
	    elseif($data['frontend_input'] == 'text'){
                $defaultValueField = 'default_value_text';
            }
	    elseif($data['frontend_input'] == 'date'){
